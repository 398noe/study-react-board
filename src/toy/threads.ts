import {
    threadsGetResponse200,
    threadsGetResponse400,
    threadsGetResponse500,
    threadsPostParameters,
    threadsPostResponse200,
    threadsPostResponse400,
    threadsPostResponse500,
} from "../types/threads";
